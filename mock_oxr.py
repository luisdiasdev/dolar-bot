...
class MockOXR(OXR):
    ...
    def get_latest_data(self):
        res = json.loads(
            '{"disclaimer":"Usage subject to terms: https://openexchangerates.org/terms","license":"https://openexchangerates.org/license","timestamp":1659977997,"base":"USD","rates":{"BRL":15.9916}}'
        )
